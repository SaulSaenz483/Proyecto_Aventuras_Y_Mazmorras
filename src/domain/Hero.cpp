...
Hero::Hero(string n, int health, int attack):Entity(n), hp(health), baseAttack(attack){}

//Como hay un puntero dinamico, debemos limpiar la memoria dinamica
...
void Hero:: interact(){
    cout << name << " is ready for battle! HP: " << hp << "\n";
}
